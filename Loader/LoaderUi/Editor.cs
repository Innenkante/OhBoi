...
namespace LoaderUi
{
    class Editor
    {
        ...
        class DynamicCollection : IEnumerable<AutocompleteMenuNS.AutocompleteItem>
        {
            ...
            public DynamicCollection(ScintillaNET.Scintilla tb, List<Keyword> source)
            {
                _tb = tb;
                _keywords = source;
        ...
        private DynamicCollection _autocompleteItems;
        ...
        private void InitializeKeywords()
        {
            ...
            _autocompleteItems = new DynamicCollection(_codeArea, keywords);
